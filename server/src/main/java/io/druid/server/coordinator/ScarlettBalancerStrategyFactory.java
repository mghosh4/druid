...
public class ScarlettBalancerStrategyFactory implements BalancerStrategyFactory
{
  private final int threadCount;

  public ScarlettBalancerStrategyFactory(int costBalancerStrategyThreadCount)
  {
