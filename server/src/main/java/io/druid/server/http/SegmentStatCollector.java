...
public final class SegmentStatCollector {
	private static final Logger log = new Logger(SegmentStatCollector.class);
	...
	@Inject
	public SegmentStatCollector(ObjectMapper mapper){
		this.segmentList = new CopyOnWriteArrayList<>();
		this.mapper = mapper;
	}
	
	public SegmentStatCollector() {
