...
/**
*/
class ByteCountingMap extends LinkedHashMap<ByteBuffer, byte[]>
{
  private static final Logger log = new Logger(ByteCountingMap.class);

  protected final boolean logEvictions;
  protected final int logEvictionCount;
  protected final long sizeInBytes;

  protected volatile long numBytes;
  protected volatile long evictionCount;

  public ByteCountingMap(
